...
export default function SearchBar({BASE_URL_SPOTIFY}:any){
  ...
  return(
    <div onKeyDown={handleKeyDown} className="w-full relative flex lg:w-[80%] px-6 py-2 rounded-xl bg-(--background-secondary) items-center gap-2">
      ...
      <div className={`w-full absolute top-11 left-0 results-wrapper z-10 ${results?"show":"none"}`}>
        {showResults()}
      </div>
    </div>
