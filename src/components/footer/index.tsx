          ...
          <div className="footer__links">
            <div className="footer__column">
              ...
              <ul className="footer__list">
                <li><a href="#sobre" className="footer__link">Se vira</a></li>
                <li><a href="#projetos" className="footer__link">Se vira</a></li>
                <li><a href="#tecnologias" className="footer__link">Se vira</a></li>
                <li><a href="#contato" className="footer__link">Se vira</a></li>
              </ul>
            </div>
            ...
            <div className="footer__column">
              ...
              <ul className="footer__list">
                ...
                <li><a href="#" className="footer__link">Se vira</a></li>
                <li><a href="#" className="footer__link">Se vira</a></li>
                <li><a href="#" className="footer__link">Se vira</a></li>
              </ul>
            </div>
            ...
            <div className="footer__column">
              ...
              <ul className="footer__list">
                <li><a href="mailto:contato@exemplo.com" className="footer__link">contato@exemplo.com</a></li>
                <li><a href="tel:+5586999999999" className="footer__link">+55 (86) 99999-9999</a></li>
